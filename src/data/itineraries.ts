...
const dayTemplates: Record<string, GeneratedDay[]> = {
  ...
  taormina: [
    ...
    },
    {
      ...
      insiderTip: "Rent a boat from Mazzarò to explore the Grotta Azzurra (Blue Grotto), accessible only by sea, with otherworldly light."
    },
    {
      day: 3,
  ...
  aeolian: [
    ...
    },
    {
      ...
      afternoon: "Hike to Fossa Felci prehistoric village (abandoned by 1600 BC, no one knows why). Boat tour to Grotta del Bue Marino (Monk Seal Cave).",
  ...
  return {
    ...
    practicalInfo: {
      transportation: duration > 5 
        ? "Rental car essential for flexibility and hill towns. Book automatic transmission well in advance, as manuals are the norm. Driving tip: parking in historic centers is often restricted to residents."
